...
/**
 * Run the full demo seed using the given Prisma client. Used both by the
 * CLI entry (prisma/seed.ts) and the one-time /api/setup route, which runs
 * it from inside the deployed app where the database is reachable.
 */
